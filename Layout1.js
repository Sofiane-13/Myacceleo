...
<Button title='todo' onPress={() => this.remlirTable()} onLongPress={() => this.alerte()} buttonStyle={ styles.styleviw } icon={{name: 'squirrel', type: 'octicon', buttonStyle: styles.styleviw }}  />
</Col>
...
2
'>
<TextInput style={styles.StyleTO} placeholder="input2" onChangeText={(text) => this.setState({input2: text})} value={this.state.input2}/>
</Col>
...
2
'>
<TextInput style={styles.StyleTO} placeholder="input3" onChangeText={(text) => this.setState({input3: text})} value={this.state.input3}/>
</Col>
